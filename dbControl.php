...
if ($_POST) {
    ...
    $results = $mysqli->query("INSERT INTO markers (description, lat, lng, type, address, date, deleted, resolved_by) VALUES ('$mDesc',$mLat, $mLng, '$mType', '$mAddress', '$mDate', '$mDeleted', '$username')");
    if (!$results) {
